...
public class StartMenuScreenTest{
    private StartMenuScreen screen;
    ...
    public void start(){
        ...
        screen = new StartMenuScreen(boatGameInstance);
    }

    @Test
    public void PauseScreenCreated(){
        screen.resize(5,5);
        assertNotNull("Start menu screen not initialised",screen);
    }
