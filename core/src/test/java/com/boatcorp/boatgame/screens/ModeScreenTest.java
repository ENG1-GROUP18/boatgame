...
public class ModeScreenTest {
    private ModeScreen screen;
    ...
    public void start(){
        ...
        screen = new ModeScreen(boatGameInstance);
    }

    @Test
    public void ModeScreenCreated(){
        screen.resize(5,5);
        assertNotNull("Mode Screen not initialised",screen);
    }
